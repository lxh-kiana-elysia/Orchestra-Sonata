...
> 6. **绑定 = 彩蛋**：异想体绑定乐队少女**仅用于叙事彩蛋**（专属台词/背景呼应），**不影响任何数值与流程**（GDD v1.5）。异想体可先于对应角色出现，属正常设计。
...
| Day 2-6 | 60% | 40% | — | — | — |
| Day 7-12 | 30% | 50% | 20% | — | — |
| Day 13-25 | 10% | 35% | 40% | 15% | — |
| Day 26-40 | — | 15% | 40% | 35% | 10% |
| Day 41-50 | — | — | 20% | 45% | 35% |

> 默认 `minDay`：ZAYIN/TETH=1、HE=7、WAW/ALEPH=13（参考脑叶解锁节奏）。百分比为占位，待调参。
