...
> 上游依据：`GDD.docx` **v1.10**（设计宪法） · `agent.md` **v3.6**（AI 执行手册）
...
| 文档 | 作用 |
|---|---|
| `GDD.docx` v1.10 | **设计宪法**：玩法规则、数值、流程、UI 分层、视觉规范 |
| `agent.md` v3.6 | **AI 执行手册**：职责边界、工作流程、代码标准、协作规范 |
