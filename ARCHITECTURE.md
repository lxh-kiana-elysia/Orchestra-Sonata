...
> 上游依据：`GDD.docx` **v1.4**（设计宪法） · `agent.md` **v3.1**（AI 执行手册）
...
| 文档 | 作用 |
|---|---|
| `GDD.docx` v1.4 | **设计宪法**：玩法规则、数值、流程、UI 分层、视觉规范 |
| `agent.md` v3.1 | **AI 执行手册**：职责边界、工作流程、代码标准、协作规范 |
| `ARCHITECTURE.md`（本文件） | **技术架构**：分层、模块、接口、数据流 |
| `README.md` | 项目概览 |
